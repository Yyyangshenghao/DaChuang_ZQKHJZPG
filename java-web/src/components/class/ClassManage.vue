<template>
  <div>
    ...
    <el-table :data="tableData"
      ...
      <el-table-column prop="name" label="证券级别" width="180">
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        <el-form-item label="证券级别" prop="name">
          <el-col :span="18">
...
export default {
  ...
  methods:{
    ...
    doSave(){
      this.$axios.post(this.$httpUrl+'/class1/save', this.form).then(res=>res.data).then(res=>{
        console.log(res)
        if(res.code == 200){
          this.$message({
            message: '操作成功',
    ...
    doModify(){
      this.$axios.post(this.$httpUrl+'/class1/update', this.form).then(res=>res.data).then(res=>{
        console.log(res)
        if(res.code == 200){
          this.$message({
            message: '操作成功',
    ...
    Delete(id){
      this.$axios.get(this.$httpUrl+'/class1/delete?id='+id).then(res=>res.data).then(res=>{
        console.log(res)
        if(res.code == 200){
          this.$message({
            message: '操作成功',
    ...
    loadPost(){
      this.$axios.post(this.$httpUrl+'/class1/listPage',{
